                ...
                btn 
                    ?  <div className="listMore">
                            <div className="moreBlock">
                                <div><i className="fas fa-map-pin"></i><p onClick={()=>{dispatch(updateTopApi(evt.id, path === "day" ? "todos" : path === "week" ? "week.todos" : path === "month" ? "month.todos" : "year.todos"))}}>Unset pin</p></div>
